...
<!doctype html>
    ...
    <head>
        ...
        <title>Modification Ruche | Republic - Of - Beehives</title>
    ...
    <body>
        ...
        <main role="main">
            ...
            <div class="container">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name_update" placeholder="Exemple Ruche 1">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Latitude :</label>
                    <input type="number" class="form-control" id="latitude_update" placeholder="Exemple 54.5845451">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Longitude :</label>
                    <input type="number" class="form-control" id="longitude_update" placeholder="Exemple 68.547851">
                </div>
                <button type="submit" class="btn btn-success" id="updateBeehives">Modifier</button>
        ...
        <script>
            //Set the default value of the URL
            let params = new URLSearchParams(location.search);
            document.getElementById('name_update').value = params.get('name');
            document.getElementById('latitude_update').value = params.get('latitude');
            document.getElementById('longitude_update').value = params.get('longitude');
        </script>
    </body>
</html>
